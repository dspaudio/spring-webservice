...
insert into file (post_Id, file_Name, file_Url, file_Path, mime_Type, file_Size, created_date, modified_date) 
  values (1, 'filename.jpg', '/2019/07/15/filename.jpg', '\2019\07\15\filename.jpg', 'image/jpeg', 1000, now(), now());
insert into file (post_Id, file_Name, file_Url, file_Path, mime_Type, file_Size, created_date, modified_date) 
  values (1, 'filename2.jpg', '/2019/07/15/filename2.jpg', '\2019\07\15\filename2.jpg', 'image/jpeg', 2000, now(), now());
insert into file (post_Id, file_Name, file_Url, file_Path, mime_Type, file_Size, created_date, modified_date) 
  values (2, 'filename3.jpg', '/2019/07/15/filename3.jpg', '\2019\07\15\filename3.jpg', 'image/jpeg', 3000, now(), now());
