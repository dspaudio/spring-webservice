...
insert into board (board_Name, category_Use_Flag, hierarchy_Use_Flag, comment_Use_Flag, notice_Use_Flag, file_Use_Flag, del_Flag, created_By_id, created_date, modified_date) 
